...
#  end
  ...
  #10.times do
    ...
    [10].each do |collision_clearance_coeff|
      %w[needle_steering_reint].each do |pg_name|
        [1, 2].each do |method|
          [[1, 0]].each do |separate_planning_first, simultaneous_planning|
            exp_options = {
            ...
            Record.create! exp_options.merge command: command, result: result, pg_name: pg_name, problem: :needle_steering, version: 10808
          end
        end
      end
    end

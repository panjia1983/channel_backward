...
200.times do
  ...
  seed = rand(100000000)
  %w[needle_steering_10607].each do |pg_name|
    [1, 2].each do |method|
      [[1, 0], [0, 1]].each do |separate_planning_first, simultaneous_planning|
        ...
        Record.create! exp_options.merge command: command, result: result, pg_name: pg_name, problem: :needle_steering, version: 10607, description: "5 needles test"
      end
    end
  end
